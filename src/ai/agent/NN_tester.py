...
class NNTester:
    """
    Stable evaluator for NN-based expectimax agent.
    """
    ...
    def __init__(
        ...
        try:
            ...
            # Allow testing even when checkpoint is absent.
            pass
    ...
    def run(
        ...
        games: list[dict] = []
        for i in tqdm(range(num_games), desc=f"NN Test(d={self.agent.config.depth})"):
    ...
    def _plot_report(report: dict, output_image_path: str | Path) -> Path | None:
        ...
        fig.suptitle("NN Test Report", fontsize=14)
    ...
    def _open_image(path: Path) -> None:
        try:
            ...
            # Non-fatal: report is already saved on disk.
            pass


def main() -> None:
    # Optional: set checkpoint path for testing.
    # Example: "artifacts/nn_evaluator.pt"
    ...
    print(
        ...
        f"plot=artifacts/nn_test_report_depth2.png"
    )
